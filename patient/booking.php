             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">All Therapists</p></a></div>
                    </td>
                </tr>
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                        ...
                                        <tr>
                                            ...
                                            <a href="mpesa.php"> <button class="login-btn btn-primary btn btn-book" style="margin-left:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;">Pay Here</button></a>
&nbsp;&nbsp;&nbsp;
                                              <a href="list.html"> <button class="login-btn btn-primary btn btn-book" style="margin-left:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;">Do Self test</button></a>
                                            </td>
                                        </tr>
                                        '; 
