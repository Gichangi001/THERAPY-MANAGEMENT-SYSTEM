                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about our therapists? no problem let's jump to 
                                <a href="doctors.php" class="non-style-link"><b>"Find Therapists"</b></a> section or 
                                <a href="schedule.php" class="non-style-link"><b>"Sessions"</b> </a><br>
                                Track your past and future appointments history.<br>Also find out the expected time for your session.<br><br>
                            </p>
                            
                            <h3>Search for a therapist Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search for a therapist and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;
