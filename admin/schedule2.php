                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <form action="" method="post">
                            ...
                            <input type="date" name="start_date" id="start_date" class="input-text filter-container-items" style="margin: 0;width: 95%;">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="date" name="end_date" id="end_date" class="input-text filter-container-items" style="margin: 0;width: 95%;">
...
if ($_POST) {
    ...
    // Check and add condition for scheduledate
    if (!empty($_POST["start_date"]) && !empty($_POST["end_date"])) {
        $start_date = $_POST["start_date"];
        $end_date = $_POST["end_date"];
        $sqlConditions[] = " schedule.scheduledate BETWEEN '$start_date' AND '$end_date' ";
    }

    // Check and add condition for docid
    if (!empty($_POST["docid"])) {
        $docid = $_POST["docid"];
        $sqlConditions[] = " doctor.docid = $docid ";
    }
    ...
    // Order by scheduledate in descending order
    ...
    if ($result) {
        if ($result->num_rows > 0) {
            ...
            echo "<tr><td colspan='6'>No sessions found for the specified criteria.</td></tr>";
        }
        ...
        echo "<tr><td colspan='6'>Error executing query: " . $database->error . "</td></tr>";
    }

    echo "</table>";
} else {
    // Display a default message or form
    echo "Please submit the form to retrieve sessions.";
}
?>
